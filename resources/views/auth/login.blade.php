        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md border border-gray-200">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-gray-600">Don't have an account? <a href="{{ route('register') }}" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150 ease-in-out">Register now</a></p>
                </div>
            </form>
        </div>
    </div>
